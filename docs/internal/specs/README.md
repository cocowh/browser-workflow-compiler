...
Specs combine requirements, solution design, risks, and acceptance criteria for a specific capability.

## Naming

Use date plus capability name:
...
- [Backend Analysis API Seed](./2026-06-14-backend-analysis-api-seed.md)
